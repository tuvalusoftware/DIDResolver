    ...
    it("it should return 'invalid string error' as the params contains invalid character", (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          expect(isSameError(res.body, ERRORS.INVALID_STRING)).equal(true);
    ...
    it("it should return a success message", (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          expect(JSON.stringify(res.body)).equal(
            JSON.stringify(DID_CONTROLLER_OPERATION_STATUS.UPDATE_SUCCESS)
          );
    ...
    it("it get data of a DID", (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          expect(JSON.stringify(res.body)).equal(
            JSON.stringify(DID_CONTROLLER_OPERATION_STATUS.DELETE_SUCCESS)
          );
