...
export const commonlandsDocument = {
  ...
  put: {
    tags: ["Commonlands Document"],
    summary:
      "Update a Land Certificate for the Commonlands Project. This function serves as a wrapper for the DID Document",
    requestBody: {
      require: true,
      content: {
        "application/json": {
...
export const getDocumentInformation = {
  get: {
    ...
    responses: {
      200: {
        description: "Return an object include document information if success",
        content: {
          "application/json": {
            examples: {
              ...
              "Get lastest version successfully": {
                value: {
                  data: {
                    ...
                    title:
                      "a04c26b0-cb31-42c0-9807-ef27c7aa7a5c:string:Land-Certificate-VNZ-739",
                    No: "4bb4b5f5-5a9c-4135-9f7d-05fa3adcb216:string:cb00fac",
                    dateIssue:
                      "c42e68b5-2425-4093-8ec4-5962dd022bf2:string:2023-09-28 16:52:47",
                    avatar:
                      "177927d7-181b-443b-b78a-76fa41f42481:string:https://commonlands-dev-bucket-aws.s3.us-west-1.amazonaws.com/1692108209887-Darius%2520Golkar.jpg_avatar?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=AKIAZBVJQENNESITE3MS%2F20230823%2Fus-west-1%2Fs3%2Faws4_request&X-Amz-Date=20230823T065041Z&X-Amz-Expires=604800&X-Amz-Signature=bc409ae32ddafef898259c211778e1c1750e0d340f6f0794028efcbf3377c472&X-Amz-SignedHeaders=host&x-id=GetObject",
                    personalInformation: {
                      claimant:
                        "415bb159-fc70-438c-b16e-cec3016496a7:string:Darius Golkar",
                      right:
                        "d426487c-deae-4f10-872a-3bea28f2cabe:string:owner",
                      phoneNumber:
                    ...
                    plotInformation: {
                      ...
                      plotId:
                        "2e1087d6-2a8e-4baa-a656-4af6f31a0ad1:string:Plot:64db86559e77a4ffc2395adc",
                      plot_Id:
