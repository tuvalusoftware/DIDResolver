...
import { handlePromiseAllSettle } from "../../../utils/index.js";
...
export default {
    getTransactionIdByDid: asyncWrapper(async (req, res, next) => {
        ...
        // const documentResponse = await ControllerService(accessToken).isExisted({
        //     companyName,
        //     fileName,
        // });
        const credentialResponse = await ControllerService(
            accessToken
        ).getCredentialByDid({ did });
